...
export interface paths {
    ...
    "/api/v1/debrid/provider": {
        ...
        /** Get Provider Info */
        get: operations["get_provider_info_api_v1_debrid_provider_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/debrid/cache": {
        ...
        /** Check Cache */
        get: operations["check_cache_api_v1_debrid_cache_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/debrid/torrent": {
        ...
        put?: never;
        /** Add Torrent */
        post: operations["add_torrent_api_v1_debrid_torrent_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/debrid/torrent/{torrent_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Torrent Info */
        get: operations["get_torrent_info_api_v1_debrid_torrent__torrent_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/debrid/link": {
        ...
        /** Get Download Link */
        get: operations["get_download_link_api_v1_debrid_link_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/debrid/download": {
        ...
        put?: never;
        /** Download File */
        post: operations["download_file_api_v1_debrid_download_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        DebridCacheStatus: {
            /** Is Cached */
            is_cached: boolean;
            provider?: components["schemas"]["DebridProvider"] | null;
            /** Name */
            name?: string | null;
            /** Size */
            size?: number | null;
         ...
         * @enum {string}
         */
        DebridProvider: "torbox" | "realdebrid" | "alldebrid";
        /** DebridProviderInfo */
        DebridProviderInfo: {
            id: components["schemas"]["DebridProvider"];
            /** Name */
            name: string;
            /** Description */
            description: string;
            ...
            /** Supports Cache Check */
            supports_cache_check: boolean;
        };
        /** DebridTorrentInfo */
        DebridTorrentInfo: {
            /** Id */
        ...
        IndexerQueryResult: {
            ...
            /**
             * Info Hash
             * @description Extract info hash from magnet URL for debrid cache checking.
             */
            readonly info_hash: string | null;
            /** Season */
...
export interface operations {
    ...
    get_provider_info_api_v1_debrid_provider_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DebridProviderInfo"];
                };
            };
        };
    };
    check_cache_api_v1_debrid_cache_get: {
        parameters: {
            query: {
                hash: string;
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DebridCacheStatus"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    add_torrent_api_v1_debrid_torrent_post: {
        parameters: {
            query: {
                magnet: string;
            };
    ...
    get_torrent_info_api_v1_debrid_torrent__torrent_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DebridTorrentInfo"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_download_link_api_v1_debrid_link_get: {
        parameters: {
            query: {
                torrent_id: string;
                file_id: string;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DebridDirectLink"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    download_file_api_v1_debrid_download_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DebridDownloadRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
