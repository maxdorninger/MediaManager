...
export interface paths {
	...
	'/api/v1/auth/cookie/OpenID/authorize': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		/** Oauth:Openid.Cookie.Authorize */
		get: operations['oauth_OpenID_cookie_authorize_api_v1_auth_cookie_OpenID_authorize_get'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/auth/cookie/OpenID/callback': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		/**
		 * Oauth:Openid.Cookie.Callback
		 * @description The response varies based on the authentication backend used.
		 */
		get: operations['oauth_OpenID_cookie_callback_api_v1_auth_cookie_OpenID_callback_get'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
...
export interface operations {
	...
	oauth_OpenID_cookie_authorize_api_v1_auth_cookie_OpenID_authorize_get: {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
	...
	oauth_OpenID_cookie_callback_api_v1_auth_cookie_OpenID_callback_get: {
		parameters: {
			query?: {
				code?: string | null;
